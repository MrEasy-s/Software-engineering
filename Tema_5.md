...
Оба типа данных могут содержать в себе разные типы. Списки в отличи от множеств могут содеражать идентичные элементы. Также элементы в списках имеют соответсвубщие индексы, в отличии от множеств 
